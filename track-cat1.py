...
img = cv2.imread('d:\image1\cat.png')
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
gray = np.float32(gray)

corners = 0
ccorners = cv2.goodFeaturesToTrack(gray, 100, 0.0001, 10)
...
m = folium.Map(
        ...
        zoom_start=15,
        tiles='https://1.base.maps.ls.hereapi.com/maptile/2.1/maptile/newest/reduced.day/{z}/{x}/{y}/256/png?lg=RU&apiKey={API_KEY}',
        attr='HERE'
    )
